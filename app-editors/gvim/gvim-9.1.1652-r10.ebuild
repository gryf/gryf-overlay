...
LICENSE="vim"
SLOT="0"
IUSE="acl aqua crypt cscope debug gtk2 gtk3 lua minimal motif neXt netbeans nls perl python racket ruby selinux session sound tcl wayland ${GENTOO_PERL_USESTRING}"
REQUIRED_USE="
